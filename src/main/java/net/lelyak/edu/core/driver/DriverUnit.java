...
import net.lelyak.edu.core.common.CommonTimeouts;
...
import static net.lelyak.edu.core.driver.Driver.chromeService;
...
public class DriverUnit {
    ...
    public static void preconfigureDriver(RemoteWebDriver driver) {
